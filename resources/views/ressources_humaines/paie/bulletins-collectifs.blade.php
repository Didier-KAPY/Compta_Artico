...
<meta charset="utf-8">
<style>
    @page{margin:28px 34px}body{font-family:DejaVu Sans,sans-serif;color:#172033;font-size:11px;margin:0}.payslip-page{position:relative;min-height:730px;page-break-after:always}.payslip-page:last-child{page-break-after:auto}.header{border-bottom:3px solid #167c80;padding-bottom:14px;margin-bottom:18px}.logo{max-height:60px;max-width:120px;float:right}h1{font-size:22px;color:#0f2744;margin:0}h2{font-size:13px;color:#167c80;margin:20px 0 8px}.muted{color:#667085}.grid{width:100%;border-collapse:collapse}.grid td{width:50%;vertical-align:top;padding:3px 8px 3px 0}.pay{width:100%;border-collapse:collapse;margin-top:8px}.pay th{background:#0f2744;color:#fff;padding:8px;text-align:left}.pay td{padding:8px;border-bottom:1px solid #dbe2ea}.amount{text-align:right}.total td{font-weight:bold;background:#eef7f7;border-top:2px solid #167c80}.net{margin-top:16px;background:#167c80;color:#fff;padding:14px;font-size:16px;font-weight:bold}.right{float:right}.footer{position:absolute;bottom:0;left:0;right:0;border-top:1px solid #ddd;padding-top:7px;color:#667085;font-size:9px}.draft{position:absolute;top:42%;left:14%;transform:rotate(-30deg);font-size:70px;color:rgba(190,0,0,.12);font-weight:bold}
</style>
</head>
<body>
