        ...
        <div class="col-xl-4">
            <div class="card border-0 shadow-sm overflow-hidden">
                ...
                <div class="card-body text-center px-4 pb-4" style="margin-top:-68px">
                    ...
                    @endif
                    <h4 class="fw-bold mt-3 mb-1">{{ $user->nom }} {{ $user->postnom }} {{ $user->prenom }}</h4>
                    ...
                    <div class="text-start d-grid gap-3">
                        <div class="d-flex align-items-center gap-3"><span class="info-icon bg-info bg-opacity-10 text-info"><i class="bi bi-building"></i></span><div><small class="text-muted d-block">Direction</small><span class="fw-semibold">{{ $user->departement?->designation ?? 'Non affecté' }}</span></div></div>
            ...
            <form action="{{ route('profil.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card border-0 shadow-sm mb-4"><div class="card-header bg-white py-3"><h5 class="fw-bold mb-0"><i class="bi bi-pencil-square text-primary me-2"></i>Informations personnelles</h5></div><div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label fw-semibold">Post nom</label><input name="postnom" maxlength="120" value="{{ old('postnom', $user->postnom) }}" class="form-control"></div><div class="col-md-6"><label class="form-label fw-semibold">Prénom <span class="text-danger">*</span></label><input type="text" name="prenom" value="{{ old('prenom', $user->prenom) }}" class="form-control @error('prenom') is-invalid @enderror" required>@error('prenom')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
                        ...
                        <div class="col-md-6"><label class="form-label fw-semibold">Direction</label><input class="form-control bg-light" value="{{ $user->departement?->designation ?? 'Non affecté' }}" readonly></div>
