...
class Employe extends Model {
 ...
 protected $casts=['date_naissance'=>'date','date_embauche'=>'date','date_depart'=>'date','expiration_piece_identite'=>'date','qr_genere_le'=>'datetime'];
 ...
 public function contrats(){return $this->hasMany(RhContrat::class);} public function presences(){return $this->hasMany(RhPresence::class);} public function conges(){return $this->hasMany(RhConge::class);} public function synthesesMensuelles(){return $this->hasMany(RhSyntheseMensuelle::class);} public function paies(){return $this->hasMany(RhPaie::class);} public function paiements(){return $this->hasMany(RhPaiement::class);} public function evaluations(){return $this->hasMany(RhEvaluation::class);} public function documents(){return $this->hasMany(RhDocument::class);}
